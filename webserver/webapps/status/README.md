# Start a simple docker status webapp data container
...
$ docker inspect --format="${template}" status_tomcat_1
8009/tcp=49153 8080/tcp=49154
$ docker port status_tomcat_1
8009/tcp -> 0.0.0.0:49157
8080/tcp -> 0.0.0.0:49158
$ curl http://$(boot2docker ip):49158/status/status.jsp
{
...
$ curl --user "admin:AJaANYAF7rFZ" http://$(boot2docker ip):49158/manager/text/list
